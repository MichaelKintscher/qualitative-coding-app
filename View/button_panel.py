...
class ButtonPanel(QWidget):
    ...
    def add_coding_assistance_button(self, button):
        """
        Add a new_button to the Coding Assistance Panel
        """
        self.button_layout.addWidget(button)

    def delete_coding_assistance_button(self, button_id):
        """
        Delete a button in the Coding Assistance Panel
        """
        for i in range(self.button_layout.count()):
            button = self.button_layout.itemAt(i).widget()
            if button.text() == button_id:
